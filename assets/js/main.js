...
function showCarousel(carouselClass) {
  var myDiv = document.querySelector('#demo');
  myDiv.classList.add('store-product');
  const carousels = document.querySelectorAll('.store-product');
  carousels.forEach(carousel => {
    if (carousel.classList.contains(carouselClass)) {
      ...
      carousel.classList.remove('activate');
    }
  });
}
